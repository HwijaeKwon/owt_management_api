 ...
 */
sealed class RoomOptions(open val name: String?,
 ...
 */
class CreateOptions(
    @Schema(description = "Name of the room", nullable = false, required = false, defaultValue = "")
 ...
 */
data class UpdateOptions(override val name: String? = null,
